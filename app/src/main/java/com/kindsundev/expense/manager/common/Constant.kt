...
class Constant {
    companion object {
        ...
        const val WALLET_BOTTOM_SHEET_WALLET_NAME = "WALLET_BOTTOM_SHEET"
        const val WALLET_BOTTOM_SHEET_DETAIL_WALLET_NAME = "WALLET_DETAIL_BOTTOM_SHEET"
        const val WALLET_BOTTOM_SHEET_TRANSACTION_NAME = "TRANSACTION_BOTTOM_SHEET"
